    ...
    <div class="min-h-screen bg-[#F5F5F5] py-16">
      <div class="container mx-auto px-4 max-w-4xl">
        <div class="text-center mb-12">
          <h1 class="text-4xl font-sans font-bold text-[#FF6600] mb-4">A propos de OnlineStore</h1>
        ...
        <div class="space-y-12">
          ...
          <section class="bg-white rounded-2xl p-8 shadow-sm shadow-sm">
            <h2 class="text-2xl font-sans font-bold text-[#FF6600] mb-4">Notre Mission</h2>
            <p class="text-gray-600 leading-relaxed">
              OnlineStore a pour mission de rendre le commerce en ligne accessible à tous les Sénégalais.
          ...
          <!-- Valeurs -->
          <section>
            <h2 class="text-2xl font-sans font-bold text-[#FF6600] mb-6 text-center">Nos Valeurs</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div class="bg-white rounded-2xl p-6 text-center shadow-sm shadow-sm">
                <div class="w-14 h-14 bg-[#F5F5F5] rounded-xl flex items-center justify-center mx-auto mb-4">
                  <svg class="w-7 h-7 text-[#FF6600]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/>
                  </svg>
                </div>
                <h3 class="font-semibold text-[#FF6600] mb-2">Proximité</h3>
              ...
              <div class="bg-white rounded-2xl p-6 text-center shadow-sm shadow-sm">
                ...
                <h3 class="font-semibold text-[#FF6600] mb-2">Confiance</h3>
              ...
              <div class="bg-white rounded-2xl p-6 text-center shadow-sm shadow-sm">
                ...
                <h3 class="font-semibold text-[#FF6600] mb-2">Simplicité</h3>
          ...
          <!-- CTA -->
          <section class="text-center bg-[#FF6600] rounded-2xl p-10 text-white">
            ...
            <a routerLink="/produits" class="inline-block bg-white text-[#FF6600] font-semibold px-8 py-3 rounded-full hover:shadow-lg transition-all">
              Voir les produits
            </a>
          </section>
        </div>
