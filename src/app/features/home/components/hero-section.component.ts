    ...
    <section class="hero">
      ...
      <div class="hero-inner">
        <div class="hero-content">
          ...
          <!-- Description -->
          <p class="hero-desc">
            Des produits de qualité sélectionnés avec soin, livrés rapidement à Dakar et dans tout
            le Sénégal. Commandez facilement via WhatsApp.
          </p>
      ...
      .hero-overlay {
        ...
        background:
          linear-gradient(
            to right,
            rgba(8, 20, 30, 0.82) 0%,
            rgba(8, 20, 30, 0.55) 55%,
            rgba(8, 20, 30, 0.25) 100%
          ),
